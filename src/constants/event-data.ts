 ...
 * Modifica estos valores para actualizar toda la landing page.
 */
export const EVENT_DATA = {
  title: 'Master Class',
  subtitle: 'FORMACIÓN PARA MÚSICOS',
  catchphrase: '«Adoradores en un solo corazón»',
  scriptureRef: '(cfr. jn 4, 23-24)',
  objective:
...
/** URLs de imágenes de fondo del Hero */
export const HERO_BACKGROUNDS = {
  concert:
    'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?q=80&w=1080&fm=webp',
  worship:
    'https://images.unsplash.com/photo-1478147427282-58a87a120781?q=80&w=1080&fm=webp',
} as const;
